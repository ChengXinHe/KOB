...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app4561.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "GET",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app4561.acapp.acwing.com.cn/api/user/bot/add/",
                type: "POST",
                data: {
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app4561.acapp.acwing.com.cn/api/user/bot/update/",
                type: "POST",
                data: {
                    bot_id: bot.id,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app4561.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "POST",
                data: {
                    bot_id: bot.id,
                },
