<template>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <router-link :class= "route_name == 'ranklist_index' ? 'nav-link acitve' : 'nav-link'" :to="{name:'ranklist_index'}">Rank</router-link>
            </li>
        </ul>
        <ul class="navbar-nav">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <router-link class="dropdown-item" :to="{name:'user_bots_index'}">My Bots</router-link>
